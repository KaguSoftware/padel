  ...
  return (
    <div className="court-world min-h-dvh bg-court-deep">
      <header className="court-surface relative overflow-hidden border-b border-line/20">
        ...
        <div className="relative flex flex-wrap items-end justify-between gap-x-6 gap-y-3 px-5 py-6">
        ...
        {note && (
          <p className="relative border-t border-line/15 px-5 py-2 font-board text-[11px] tracking-[0.08em] text-line-dim">
            {note}
          </p>
        )}
      </header>
